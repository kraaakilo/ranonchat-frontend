...
const Home = () => {
    ...
    return (
        <main className='flex relative items-center justify-center min-h-screen container mx-auto'>
    ...
    <div className="chat-message">
      <div className="flex items-end justify-end">
        <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
          <div>
            <span className="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">
              Any updates on this issue? I'm getting the same error when trying
        ...
        <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
          ...
          <div>
            <span className="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">
              ...
              {"{"}your_user_profile{"}"}
              {"}"}/.npm-global/ then install the package globally without using
              sudo
            </span>
          </div>
        </div>
      ...
      <div className="absolute right-0 items-center inset-y-0 hidden sm:flex">
        ...
        >
          ...
          >
            ...
            {/* <h2 className='text-6xl text-center font-bold'>Welcome to Ranonchat</h2>
